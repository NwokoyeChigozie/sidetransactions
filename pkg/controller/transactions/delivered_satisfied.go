...
func (base *Controller) TransactionDelivered(c *gin.Context) {
	var (
		req models.TransactionDeliveredRequest
	)
	...
	code, err := transactions.TransactionDeliveredService(base.ExtReq, base.Logger, base.Db, req, *user)
	if err != nil {
	...
	rd := utility.BuildSuccessResponse(http.StatusOK, "Transaction Delivered", nil)
	c.JSON(http.StatusOK, rd)

}

func (base *Controller) Satisfied(c *gin.Context) {
	var (
	...
	rd := utility.BuildSuccessResponse(http.StatusOK, "Transaction Delivery Accepted", nil)
	c.JSON(http.StatusOK, rd)

}

func (base *Controller) SatisfiedApi(c *gin.Context) {
	var (
		req models.OnlyTransactionIDRequiredRequest
	)
